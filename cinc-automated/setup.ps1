...
if(-not $sshCommand){
    ...
    Write-Information "command 'ssh' found." -InformationAction Continue
}
...
$clientId = (Get-EryphClientConfiguration -Configuration zero -ErrorAction SilentlyContinue).Id
